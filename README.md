...
## 🪐 Overview
Focused on low-level systems programming, reverse engineering, and software protection mechanisms. Passionate about understanding complex architectures, analyzing system-level behaviors, and breaking down security frameworks under the hood.

* **Core Focus:** Windows Internals, Kernel-mode development, and static/dynamic binary analysis.
* **Approach:** Driven by curiosity, guided by source code, and validated through execution.
